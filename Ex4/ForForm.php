...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  if (empty($_POST['email'])) {
    ...
    setcookie('email_value', $_POST['fio']);
  ...
  if (empty($_POST['date'])) {
    ...
    setcookie('date_value', $_POST['fio']);
  ...
  if (empty($_POST['superpowers'])) {
    ...
    setcookie('superpowers_value', $_POST['fio']);
  ...
  if (empty($_POST['limbs'])) {
    ...
    setcookie('limbs_value', $_POST['fio']);
